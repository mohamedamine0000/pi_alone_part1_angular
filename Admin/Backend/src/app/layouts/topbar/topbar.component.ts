...
export class TopbarComponent {
  ...
  constructor(@Inject(DOCUMENT) private document: any, private eventService: EventService, public languageService: LanguageService, public _cookiesService: CookieService, private elRef: ElementRef) {
  }
